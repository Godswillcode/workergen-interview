...
import { AllanData, JaneData } from "../constant";

export const Analysis = () => {
  const [openDetails, setOpenDetails] = useState(false);
  const [dictateUser, setDictateUser] = useState<string>();
  ...
  return (
    <>
      <LeadDetails
        ...
        data={dictateUser === "jane" ? JaneData : AllanData}
      />
        ...
        <div className="bg-white p-3 rounded-[5px] w-full h-full">
          <div className="grid grid-cols-1 gap-y-4 lg:grid-cols-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold ">
                ...
                achieved and the rest can be achieved by focusing on 20 top
                leads.{" "}
              </h3>
            </div>
          ...
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-3 mt-5">
            <div className="col-span-2">
              <h4 className="pb-3">
                Copilot has pinpointed 20 key leads that shows the string
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                <div
                  className="border shadow-sm p-2 rounded-md cursor-pointer transition duration-300 hover:scale-105 hover:border-[#325BC9]"
                  onClick={() => handleOpenDetails("jane")}
                >
                  <div className="flex items-center gap-2">
                    <Image
                      src={janeAvatar}
                ...
                <div
                  className="border shadow-sm p-2 rounded-md cursor-pointer transition duration-300 hover:scale-105 hover:border-[#325BC9]"
                  onClick={() => handleOpenDetails("allan")}
                >
                  <div className="flex items-center gap-2">
