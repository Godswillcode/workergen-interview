...
export const leadList: leadProps[] = [
  ...
  },
  {
    ...
    aboutMe: "Michael is an expert in logistics optimization for global supply chains.",
  ...
  },
  {
    ...
    aboutMe: "Lisa focuses on creating seamless customer experiences in retail.",
    position: "Customer Success Lead - RetailX",
    whyPick: "Lisa's initiatives have improved customer retention by 40%.",
    userInterest: "Lisa is interested in adopting omnichannel customer support.",
  ...
  },
  {
    ...
    aboutMe: "James has over 15 years of experience in manufacturing processes.",
  ...
  },
  {
    ...
    aboutMe: "Olivia is a marketing consultant specializing in emerging markets.",
    position: "Marketing Consultant - MarketExpansionCo",
    whyPick: "Olivia's strategies have successfully launched brands in new markets.",
  ...
  },
  {
    ...
    userInterest: "Andrew is exploring new technologies for energy optimization.",
  ...
  },
  {
    ...
    aboutMe: "Sarah specializes in optimizing business processes and reducing costs.",
    position: "COO - EfficientSystems",
    whyPick: "Sarah has implemented systems that reduced operational costs by 20%.",
    userInterest: "Sarah is looking for new ways to automate business processes.",
  ...
  },
  {
    ...
    aboutMe: "Nancy is passionate about streamlining HR processes with technology.",
  ...
  },
  {
    ...
    aboutMe: "George is a senior infrastructure engineer with a focus on scalability.",
    position: "Lead Engineer - ScaleTech",
    whyPick: "George has helped scale infrastructure for large enterprises.",
    userInterest: "George is exploring cloud solutions for infrastructure management.",
  ...
  },
  {
    ...
    userInterest: "Mia wants to explore new strategies to connect with customers.",
  ...
  },
  {
    ...
    aboutMe: "Liam is a cybersecurity expert helping businesses stay protected.",
    position: "Cybersecurity Lead - SecureTech",
    whyPick: "Liam has led efforts that reduced cyberattacks by 60%.",
    userInterest: "Liam is interested in learning about next-gen cybersecurity tools.",
  ...
  },
  {
    ...
    aboutMe: "Daniel specializes in optimizing manufacturing processes to cut costs.",
  ...
  },
  {
    ...
    aboutMe: "Zoe is an expert in streamlining retail supply chains for efficiency.",
    position: "Supply Chain Director - RetailPro",
    whyPick: "Zoe has increased supply chain efficiency by 25%.",
    userInterest: "Zoe is interested in adopting blockchain for supply chain transparency.",
  ...
  },
  {
    ...
    aboutMe: "Ethan works to enhance team dynamics and collaboration through technology.",
    position: "Collaboration Lead - TeamSync",
    whyPick: "Ethan's strategies have led to a 20% improvement in team productivity.",
    userInterest: "Ethan is looking for tools to improve virtual team collaboration.",
